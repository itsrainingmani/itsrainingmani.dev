...
tags: ["learning in public", "clojure", "open source", "clojurefam", "emacs"]
publish: true
---

import { Picture } from "astro:assets";
import lispcycles from "@/assets/xkcd-lisp-297.png";
...
<Picture class="m-auto" src={lispcycles} formats={["avif", "webp"]} alt="lisp cycles" />
